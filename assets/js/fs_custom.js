...
window.optimizelyTemplateTool = {
    initialize: function() {
        ...
        $(document).ready(function() {
            ...
            for (var key in app_config.placeholders.feature_test) {
                if (app_config.placeholders.feature_test.hasOwnProperty(key)) {
                    $('#experiment-level')
        ...
        $('#step_experiment form').submit(function(e) {
            ...
            */
            ...
            function createFeature(){
                return new Promise(function(resolve,reject){
                    optimizelyTemplateTool.spinner('Creating New Headline Feature')
